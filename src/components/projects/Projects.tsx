      ...
      <div>
        ...
        {projectData.projects.map((data) => {
          return (
            <div
              key={data.name}
              className="w-[80%] h-[800px]  mb-10 mx-auto bg-white rounded-xl p-10 "
            >
              ...
              <div className="flex flex-col  w-full h-full  xl:flex-row">
                <div className="h-[45%] xl:w-[50%] xl:h-[70%]">
                  <img
                ...
                <div className=" mx-auto pt-5 xl:p-10 xl:w-[55%] xl:h-[80%] xl:ml-10 xl:border xl:border-slate-200 xl:rounded-xl ">
